...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			constructor = reflectClass.getConstructor(new Class[]{Pilot.class});
		...
		try {
			...
			newEnemyShip = (UFOEnemyShip) constructor.newInstance(pilt);
        ...
        try {
			...
			UFOEnemyShip enemyshipPrivate = new UFOEnemyShip(pilt);
			...
			Object[] params = new Object[]{10, new String("Random")};
